...
- 83 tests passing (models + config layers)
...
- Optional: `CWM_MEMBER_IDENTIFIER`, `CWM_VERIFY_SSL`, `CWM_LOG_PATH`, `CWM_LOG_LEVEL`
...
- All API calls must go through `ConnectWiseAPI._request` for consistent error handling and logging.
